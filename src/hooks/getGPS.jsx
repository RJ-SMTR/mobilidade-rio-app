...
export function GPSProvider({ children }) {
    ...
    const URL = atob(import.meta.env.BRT_URL)
    const Login = atob(import.meta.env.BRT_USR)
    const Pass = atob(import.meta.env.BRT_PW)
    const Client = atob(import.meta.env.BRT_ID)
