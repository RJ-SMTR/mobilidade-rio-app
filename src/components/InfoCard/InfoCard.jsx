...
export function InfoCard() {
    ...
    useEffect(() => {
        setSortedPlatforms(plataforms.map((e) => Object.values(e).sort((a, b) => {
                                        ...
                                        <div className={styles.routeName}>
                                            {Object.values(values)[0].stop_desc ? <>
                                                ...
                                                : <>
                                                    <div className={styles.shortName}>
                                                        <img src={pin} alt="" />
                                                        <p className="text-sm ml-2.5 text-white">{'Ônibus: Plataforma ' + Object.values(values)[0].platform_code}</p>
                                                    </div>
                                                </>}
